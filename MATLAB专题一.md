...
1. **矩阵元素的引用方式**
  ...
  - 下标和序号可以通过**sub2ind函数**和**ind2sub函数**进行相互转换
   ...
   <img src="./img/image-20210618153701646.png" alt="image-20210618153701646" style="zoom: 67%;" /> 
  ...
  <img src="./img/image-20210618153942434.png" alt="image-20210618153942434" style="zoom:67%;" />	
